...
abstract class AbstractRepository implements RepositoryInterface
{
     ...
     * @var bool|null
     */
    private static $isDBLoggingEnabled;

     /**
     * AbstractRepository constructor.
     * @param null $isDBLoggingEnabled
     */
    public function __construct($isDBLoggingEnabled = null)
    {
        // used for tests
        self::$isDBLoggingEnabled = $isDBLoggingEnabled;
    }
    ...
    {
        $isDbLogging = $this->isDbLogging();
        if ($isDbLogging && self::$lastInsertId) {
            $model->setId(self::$lastInsertId);
            self::$lastInsertId = null;
        }
    }

    private function isDbLogging()
    {
        if (is_null(self::$isDBLoggingEnabled)) {
            self::$isDBLoggingEnabled =
                $this->getRepository()
        ...
        return self::$isDBLoggingEnabled;
    }
}