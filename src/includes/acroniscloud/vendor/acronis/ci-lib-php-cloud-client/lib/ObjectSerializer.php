    ...
    public static function sanitizeForSerialization($data, $type = null, $format = null)
    {
        if (is_scalar($data) || null === $data) {
            ...
            foreach ($data::swaggerTypes() as $property => $swaggerType) {
                $validator = $data::validators()[$property];
                $error = $data->$validator();
                if (!empty($error)) {
                    throw new \InvalidArgumentException($error);
                }
                $checker = $data::checkers()[$property];
                if (!$data->$checker()) {
                    continue;
                }
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        if (null === $data) {
            ...
            if (Configuration::getDefaultConfiguration()->getDebug()) {
                Configuration::getDefaultConfiguration()->getLogger()->debug("Written $byte_written byte to $filename. Please move the file to a proper folder or delete the temp file after processing.");
            }
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\Acronis\Cloud\Client\Model\\' . $data->{$discriminator};
