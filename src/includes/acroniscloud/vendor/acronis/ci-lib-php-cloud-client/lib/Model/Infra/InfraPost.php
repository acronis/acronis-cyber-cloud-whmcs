 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class InfraPost extends BaseModel 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Infra\InfraPost';
    ...
    public function setOwnerTenantId($owner_tenant_id)
    {
        if ((strlen($owner_tenant_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $owner_tenant_id when calling InfraPost., must be smaller than or equal to 36.');
        }
        if ((strlen($owner_tenant_id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $owner_tenant_id when calling InfraPost., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/", $owner_tenant_id))) {
            throw new \InvalidArgumentException("invalid value for $owner_tenant_id when calling InfraPost., must conform to the pattern /[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/.");
        }
    ...
    public function setLocationId($location_id)
    {
        if (!is_null($location_id) && (strlen($location_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $location_id when calling InfraPost., must be smaller than or equal to 36.');
        }
        if (!is_null($location_id) && (strlen($location_id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $location_id when calling InfraPost., must be bigger than or equal to 36.');
        }
        if (!is_null($location_id) && (!preg_match("/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/", $location_id))) {
            throw new \InvalidArgumentException("invalid value for $location_id when calling InfraPost., must conform to the pattern /[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/.");
        }
    ...
    public function setUrl($url)
    {
        ...
        if ((!preg_match("/^[a-z0-9\\+]+:\/\/[^\\s\/$.?#].[^\\s]*/", $url))) {
            throw new \InvalidArgumentException("invalid value for $url when calling InfraPost., must conform to the pattern /^[a-z0-9\\+]+:\/\/[^\\s\/$.?#].[^\\s]*/.");
        }
    ...
    public function setContentUrl($content_url)
    {
        ...
        if (!is_null($content_url) && (!preg_match("/^[a-z0-9\\+]+:\/\/[^\\s\/$.?#].[^\\s]*/", $content_url))) {
            throw new \InvalidArgumentException("invalid value for $content_url when calling InfraPost., must conform to the pattern /^[a-z0-9\\+]+:\/\/[^\\s\/$.?#].[^\\s]*/.");
        }
    ...
    public function setContentMobileUrl($content_mobile_url)
    {
        ...
        if (!is_null($content_mobile_url) && (!preg_match("/^[a-z0-9\\+]+:\/\/[^\\s\/$.?#].[^\\s]*/", $content_mobile_url))) {
            throw new \InvalidArgumentException("invalid value for $content_mobile_url when calling InfraPost., must conform to the pattern /^[a-z0-9\\+]+:\/\/[^\\s\/$.?#].[^\\s]*/.");
        }
