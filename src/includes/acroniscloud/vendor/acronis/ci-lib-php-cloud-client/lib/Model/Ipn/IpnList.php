 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class IpnList extends BaseModel 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Ipn\IpnList';
    ...
    {
        return [
            'items' => '\Acronis\Cloud\Client\Model\Ipn\Notification[]'
        ];
    }
    ...
    /**
     * Gets items
     * @return \Acronis\Cloud\Client\Model\Ipn\Notification[]
     */
    ...
    /**
     * Sets items
     * @param \Acronis\Cloud\Client\Model\Ipn\Notification[] $items
     * @return $this
     */
