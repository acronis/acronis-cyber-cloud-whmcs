...
/**
 * BillingPeriodsOfferingItem Class Doc Comment
 *
 * @category    Class
 * @package     Acronis\Cloud\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class BillingPeriodsOfferingItem extends BaseModel 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Billing\BillingPeriodsOfferingItem';
    ...
    public function setApplicationId($application_id)
    {
        if ((strlen($application_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $application_id when calling BillingPeriodsOfferingItem., must be smaller than or equal to 36.');
        }
        if ((strlen($application_id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $application_id when calling BillingPeriodsOfferingItem., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/", $application_id))) {
            throw new \InvalidArgumentException("invalid value for $application_id when calling BillingPeriodsOfferingItem., must conform to the pattern /[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/.");
        }
    ...
    public function setInfraComponentId($infra_component_id)
    {
        if (!is_null($infra_component_id) && (strlen($infra_component_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $infra_component_id when calling BillingPeriodsOfferingItem., must be smaller than or equal to 36.');
        }
        if (!is_null($infra_component_id) && (strlen($infra_component_id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $infra_component_id when calling BillingPeriodsOfferingItem., must be bigger than or equal to 36.');
        }
        if (!is_null($infra_component_id) && (!preg_match("/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/", $infra_component_id))) {
            throw new \InvalidArgumentException("invalid value for $infra_component_id when calling BillingPeriodsOfferingItem., must conform to the pattern /[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/.");
        }
