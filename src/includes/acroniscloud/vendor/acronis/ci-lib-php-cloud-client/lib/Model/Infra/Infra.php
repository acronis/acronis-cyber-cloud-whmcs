...
class Infra extends BaseModel 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Infra\Infra';
    ...
    {
        if ((strlen($id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $id when calling Infra., must be smaller than or equal to 36.');
        }
        if ((strlen($id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $id when calling Infra., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling Infra., must conform to the pattern /[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/.");
        }
    ...
    public function setOwnerTenantId($owner_tenant_id)
    {
        if ((strlen($owner_tenant_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $owner_tenant_id when calling Infra., must be smaller than or equal to 36.');
        }
        if ((strlen($owner_tenant_id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $owner_tenant_id when calling Infra., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/", $owner_tenant_id))) {
            throw new \InvalidArgumentException("invalid value for $owner_tenant_id when calling Infra., must conform to the pattern /[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/.");
        }
    ...
    public function setLocationId($location_id)
    {
        if ((strlen($location_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $location_id when calling Infra., must be smaller than or equal to 36.');
        }
        if ((strlen($location_id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $location_id when calling Infra., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/", $location_id))) {
            throw new \InvalidArgumentException("invalid value for $location_id when calling Infra., must conform to the pattern /[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/.");
        }
    ...
    public function validateLocationId()
    {
        if (!$this->offsetExists('location_id')) {
            return "Property 'location_id' was not initialized.";
        }
    ...
    /**
     * Sets platform_owned
     * @param bool $platform_owned Is infra component owned by Platform
     * @return $this
     */
    ...
    public function setUrl($url)
    {
        ...
        if ((!preg_match("/^[a-z0-9\\+]+:\/\/[^\\s\/$.?#].[^\\s]*/", $url))) {
            throw new \InvalidArgumentException("invalid value for $url when calling Infra., must conform to the pattern /^[a-z0-9\\+]+:\/\/[^\\s\/$.?#].[^\\s]*/.");
        }
    ...
    public function validateCapabilities()
    {
        if (!$this->offsetExists('capabilities')) {
            return "Property 'capabilities' was not initialized.";
        }
        return false;
    }
    ...
    public function setContentUrl($content_url)
    {
        ...
        if (!is_null($content_url) && (!preg_match("/^[a-z0-9\\+]+:\/\/[^\\s\/$.?#].[^\\s]*/", $content_url))) {
            throw new \InvalidArgumentException("invalid value for $content_url when calling Infra., must conform to the pattern /^[a-z0-9\\+]+:\/\/[^\\s\/$.?#].[^\\s]*/.");
        }
    ...
    public function setContentMobileUrl($content_mobile_url)
    {
        ...
        if (!is_null($content_mobile_url) && (!preg_match("/^[a-z0-9\\+]+:\/\/[^\\s\/$.?#].[^\\s]*/", $content_mobile_url))) {
            throw new \InvalidArgumentException("invalid value for $content_mobile_url when calling Infra., must conform to the pattern /^[a-z0-9\\+]+:\/\/[^\\s\/$.?#].[^\\s]*/.");
        }
    ...
    public function validateBackendType()
    {
        if (!$this->offsetExists('backend_type')) {
            return "Property 'backend_type' was not initialized.";
        }
        return false;
    }
    ...
    /**
     * Sets readonly
     * @param bool $readonly True if infra details are accessible in a limited way, e.g. infra is owned by some ancestor
     * @return $this
     */
