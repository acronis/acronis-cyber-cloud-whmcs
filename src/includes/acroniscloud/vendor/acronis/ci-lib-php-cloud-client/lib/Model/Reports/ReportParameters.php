...
/**
 * ReportParameters Class Doc Comment
 *
 * @category    Class
 * @package     Acronis\Cloud\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ReportParameters extends BaseModel 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Reports\ReportParameters';
    ...
    public static function swaggerTypes()
    {
        return [
            'tenant_id' => 'string',
            'level' => '\Acronis\Cloud\Client\Model\Reports\ReportLevel',
            'formats' => '\Acronis\Cloud\Client\Model\Reports\ReportItems[]',
            'kind' => '\Acronis\Cloud\Client\Model\Reports\ReportKind',
            'period' => '\Acronis\Cloud\Client\Model\Reports\ReportPeriod'
        ];
    }
    ...
    public function setTenantId($tenant_id)
    {
        if ((strlen($tenant_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling ReportParameters., must be smaller than or equal to 36.');
        }
        if ((strlen($tenant_id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling ReportParameters., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/", $tenant_id))) {
            throw new \InvalidArgumentException("invalid value for $tenant_id when calling ReportParameters., must conform to the pattern /[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/.");
        }
    ...
    /**
     * Gets level
     * @return \Acronis\Cloud\Client\Model\Reports\ReportLevel
     */
    ...
    /**
     * Sets level
     * @param \Acronis\Cloud\Client\Model\Reports\ReportLevel $level
     * @return $this
     */
    ...
    /**
     * Gets formats
     * @return \Acronis\Cloud\Client\Model\Reports\ReportItems[]
     */
    ...
    /**
     * Sets formats
     * @param \Acronis\Cloud\Client\Model\Reports\ReportItems[] $formats Report formats
     * @return $this
     */
    ...
    /**
     * Gets kind
     * @return \Acronis\Cloud\Client\Model\Reports\ReportKind
     */
    ...
    /**
     * Sets kind
     * @param \Acronis\Cloud\Client\Model\Reports\ReportKind $kind
     * @return $this
     */
    ...
    /**
     * Gets period
     * @return \Acronis\Cloud\Client\Model\Reports\ReportPeriod
     */
    ...
    /**
     * Sets period
     * @param \Acronis\Cloud\Client\Model\Reports\ReportPeriod $period
     * @return $this
     */
