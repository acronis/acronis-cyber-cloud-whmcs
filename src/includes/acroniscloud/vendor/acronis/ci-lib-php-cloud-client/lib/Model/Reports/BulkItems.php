 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class BulkItems extends BaseModel 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Reports\BulkItems';
    ...
    public static function swaggerTypes()
    {
        return [
            'id' => 'string',
            'version' => 'int',
            'result_action' => '\Acronis\Cloud\Client\Model\Reports\BulkResultAction',
            'recipients' => 'string[]',
            'parameters' => '\Acronis\Cloud\Client\Model\Reports\BulkParameters',
            'schedule' => '\Acronis\Cloud\Client\Model\Reports\BulkSchedule',
    ...
    {
        if ((strlen($id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $id when calling BulkItems., must be smaller than or equal to 36.');
        }
        if ((strlen($id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $id when calling BulkItems., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling BulkItems., must conform to the pattern /[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/.");
        }
    ...
    /**
     * Gets result_action
     * @return \Acronis\Cloud\Client\Model\Reports\BulkResultAction
     */
    ...
    /**
     * Sets result_action
     * @param \Acronis\Cloud\Client\Model\Reports\BulkResultAction $result_action
     * @return $this
     */
    ...
    /**
     * Gets parameters
     * @return \Acronis\Cloud\Client\Model\Reports\BulkParameters
     */
    ...
    /**
     * Sets parameters
     * @param \Acronis\Cloud\Client\Model\Reports\BulkParameters $parameters
     * @return $this
     */
    ...
    /**
     * Gets schedule
     * @return \Acronis\Cloud\Client\Model\Reports\BulkSchedule
     */
    ...
    /**
     * Sets schedule
     * @param \Acronis\Cloud\Client\Model\Reports\BulkSchedule $schedule
     * @return $this
     */
    ...
    public function setGenerationDate($generation_date)
    {
        if ((strlen($generation_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $generation_date when calling BulkItems., must be smaller than or equal to 10.');
        }
        if ((strlen($generation_date) < 10)) {
            throw new \InvalidArgumentException('invalid length for $generation_date when calling BulkItems., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/\\d{4}-\\d{2}-\\d{2}/", $generation_date))) {
            throw new \InvalidArgumentException("invalid value for $generation_date when calling BulkItems., must conform to the pattern /\\d{4}-\\d{2}-\\d{2}/.");
        }
