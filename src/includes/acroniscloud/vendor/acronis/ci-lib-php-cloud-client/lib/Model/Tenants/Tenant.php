...
class Tenant extends BaseModel 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Tenants\Tenant';
    ...
    public static function swaggerTypes()
    {
        return [
            ...
            'update_lock' => '\Acronis\Cloud\Client\Model\Tenants\TenantUpdateLock',
    ...
    public static function validators() {
        return [
            ...
            'has_children' => 'validateHasChildren',
    ...
    public function listInvalidProperties()
    {
        ...
        if (!empty($this->validateHasChildren())) {
            $invalid_properties[] = $this->validateHasChildren();
        }
    ...
    {
        if ((strlen($id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $id when calling Tenant., must be smaller than or equal to 36.');
        }
        if ((strlen($id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $id when calling Tenant., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/", $id))) {
            throw new \InvalidArgumentException("invalid value for $id when calling Tenant., must conform to the pattern /[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/.");
        }
    ...
    public function validateCustomerType()
    {
        if (!$this->offsetExists('customer_type')) {
            return "Property 'customer_type' was not initialized.";
        }
        return false;
    }
    ...
    /**
     * Sets parent_id
     * @param string $parent_id ID of parent tenant
     * @return $this
     */
    ...
    /**
     * Sets path
     * @param string[] $path List of Tenant ID's that has following relationship - next tenant in the list is parent for previos one. First tenant in the list is parent for current tenant.
     * @return $this
     */
    ...
    public function validateBrandId()
    {
        if (!$this->offsetExists('brand_id')) {
            return "Property 'brand_id' was not initialized.";
        }
        return false;
    }
    ...
    public function validateInternalTag()
    {
        if (!$this->offsetExists('internal_tag')) {
            return "Property 'internal_tag' was not initialized.";
        }
        return false;
    }
    ...
    /**
     * Sets owner_id
     * @param object $owner_id Identifier of personal tenant owner user
     * @return $this
     */
    ...
    {
        return $this->offsetGet('has_children');
    }
    ...
    {
        return $this->offsetExists('has_children');
    }

    /**
     * Sets has_children
     * @param bool $has_children Flag, indicates if tenant has children
     * @return $this
     */
    public function setHasChildren($has_children)
    {
        $this->offsetSet('has_children', $has_children);
     ...
     * Unset has_children
     */
    public function unsetHasChildren() {
        $this->offsetUnset('has_children');
    }
     ...
     * @return array|boolean
     */
    public function validateHasChildren()
    {
        if (!$this->offsetExists('has_children')) {
            return "Property 'has_children' was not initialized.";
        }
        return false;
    }
    ...
    public function setDefaultIdpId($default_idp_id)
    {
        if (!is_null($default_idp_id) && (strlen($default_idp_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $default_idp_id when calling Tenant., must be smaller than or equal to 36.');
        }
        if (!is_null($default_idp_id) && (strlen($default_idp_id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $default_idp_id when calling Tenant., must be bigger than or equal to 36.');
        }
        if (!is_null($default_idp_id) && (!preg_match("/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/", $default_idp_id))) {
            throw new \InvalidArgumentException("invalid value for $default_idp_id when calling Tenant., must conform to the pattern /[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/.");
        }
    ...
    /**
     * Gets update_lock
     * @return \Acronis\Cloud\Client\Model\Tenants\TenantUpdateLock
     */
    ...
    /**
     * Sets update_lock
     * @param \Acronis\Cloud\Client\Model\Tenants\TenantUpdateLock $update_lock
     * @return $this
     */
    ...
    public function validateUpdateLock()
    {
        if (!$this->offsetExists('update_lock')) {
            return "Property 'update_lock' was not initialized.";
        }
        return false;
    }
    ...
    public function validateAncestralAccess()
    {
        if (!$this->offsetExists('ancestral_access')) {
            return "Property 'ancestral_access' was not initialized.";
        }
        return false;
    }
