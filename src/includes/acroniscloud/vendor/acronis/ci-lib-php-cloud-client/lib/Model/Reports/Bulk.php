...
class Bulk extends BaseModel 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Reports\Bulk';
    ...
    {
        return [
            'items' => '\Acronis\Cloud\Client\Model\Reports\BulkItems[]'
        ];
    }
    ...
    /**
     * Gets items
     * @return \Acronis\Cloud\Client\Model\Reports\BulkItems[]
     */
    ...
    /**
     * Sets items
     * @param \Acronis\Cloud\Client\Model\Reports\BulkItems[] $items
     * @return $this
     */
