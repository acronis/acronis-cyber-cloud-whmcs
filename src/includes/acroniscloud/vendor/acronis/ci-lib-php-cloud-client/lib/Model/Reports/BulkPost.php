 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class BulkPost extends BaseModel 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Reports\BulkPost';
    ...
    /**
     * Gets result_action
     * @return \Acronis\Cloud\Client\Model\Reports\BulkPostResultAction
     */
    ...
    /**
     * Sets result_action
     * @param \Acronis\Cloud\Client\Model\Reports\BulkPostResultAction $result_action
     * @return $this
     */
    ...
    /**
     * Gets parameters
     * @return \Acronis\Cloud\Client\Model\Reports\BulkPostParameters
     */
    ...
    /**
     * Sets parameters
     * @param \Acronis\Cloud\Client\Model\Reports\BulkPostParameters $parameters
     * @return $this
     */
    ...
    /**
     * Gets schedule
     * @return \Acronis\Cloud\Client\Model\Reports\BulkPostSchedule
     */
    ...
    /**
     * Sets schedule
     * @param \Acronis\Cloud\Client\Model\Reports\BulkPostSchedule $schedule
     * @return $this
     */
    ...
    public function setGenerationDate($generation_date)
    {
        if (!is_null($generation_date) && (strlen($generation_date) > 10)) {
            throw new \InvalidArgumentException('invalid length for $generation_date when calling BulkPost., must be smaller than or equal to 10.');
        }
        if (!is_null($generation_date) && (strlen($generation_date) < 10)) {
            throw new \InvalidArgumentException('invalid length for $generation_date when calling BulkPost., must be bigger than or equal to 10.');
        }
        if (!is_null($generation_date) && (!preg_match("/\\d{4}-\\d{2}-\\d{2}/", $generation_date))) {
            throw new \InvalidArgumentException("invalid value for $generation_date when calling BulkPost., must conform to the pattern /\\d{4}-\\d{2}-\\d{2}/.");
        }
