 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class UsageList extends BaseModel 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Usages\UsageList';
    ...
    {
        return [
            'items' => '\Acronis\Cloud\Client\Model\Usages\UsageOutput[]'
        ];
    }
    ...
    /**
     * Sets items
     * @param \Acronis\Cloud\Client\Model\Usages\UsageOutput[] $items
     * @return $this
     */
