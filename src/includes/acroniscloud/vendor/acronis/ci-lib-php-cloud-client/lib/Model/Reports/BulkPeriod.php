 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class BulkPeriod extends BaseModel 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Reports\BulkPeriod';
    ...
    {
        if ((strlen($start) > 10)) {
            throw new \InvalidArgumentException('invalid length for $start when calling BulkPeriod., must be smaller than or equal to 10.');
        }
        if ((strlen($start) < 10)) {
            throw new \InvalidArgumentException('invalid length for $start when calling BulkPeriod., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/\\d{4}-\\d{2}-\\d{2}/", $start))) {
            throw new \InvalidArgumentException("invalid value for $start when calling BulkPeriod., must conform to the pattern /\\d{4}-\\d{2}-\\d{2}/.");
        }
    ...
    {
        if ((strlen($end) > 10)) {
            throw new \InvalidArgumentException('invalid length for $end when calling BulkPeriod., must be smaller than or equal to 10.');
        }
        if ((strlen($end) < 10)) {
            throw new \InvalidArgumentException('invalid length for $end when calling BulkPeriod., must be bigger than or equal to 10.');
        }
        if ((!preg_match("/\\d{4}-\\d{2}-\\d{2}/", $end))) {
            throw new \InvalidArgumentException("invalid value for $end when calling BulkPeriod., must conform to the pattern /\\d{4}-\\d{2}-\\d{2}/.");
        }
