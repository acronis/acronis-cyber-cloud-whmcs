...
/**
 * ReportPostParameters Class Doc Comment
 *
 * @category    Class
 * @package     Acronis\Cloud\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ReportPostParameters extends BaseModel 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Reports\ReportPostParameters';
    ...
    public function setTenantId($tenant_id)
    {
        if ((strlen($tenant_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling ReportPostParameters., must be smaller than or equal to 36.');
        }
        if ((strlen($tenant_id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $tenant_id when calling ReportPostParameters., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/", $tenant_id))) {
            throw new \InvalidArgumentException("invalid value for $tenant_id when calling ReportPostParameters., must conform to the pattern /[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/.");
        }
    ...
    /**
     * Gets level
     * @return \Acronis\Cloud\Client\Model\Reports\ReportPostLevel
     */
    ...
    /**
     * Sets level
     * @param \Acronis\Cloud\Client\Model\Reports\ReportPostLevel $level
     * @return $this
     */
    ...
    /**
     * Gets kind
     * @return \Acronis\Cloud\Client\Model\Reports\ReportPostKind
     */
    ...
    /**
     * Sets kind
     * @param \Acronis\Cloud\Client\Model\Reports\ReportPostKind $kind
     * @return $this
     */
    ...
    /**
     * Gets formats
     * @return \Acronis\Cloud\Client\Model\Reports\ReportPostItems[]
     */
    ...
    /**
     * Sets formats
     * @param \Acronis\Cloud\Client\Model\Reports\ReportPostItems[] $formats Report formats
     * @return $this
     */
    ...
    /**
     * Gets period
     * @return \Acronis\Cloud\Client\Model\Reports\ReportPostPeriod
     */
    ...
    /**
     * Sets period
     * @param \Acronis\Cloud\Client\Model\Reports\ReportPostPeriod $period
     * @return $this
     */
