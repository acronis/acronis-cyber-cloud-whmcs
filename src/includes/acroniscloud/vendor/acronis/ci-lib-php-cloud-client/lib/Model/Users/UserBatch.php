 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class UserBatch extends BaseModel 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Users\UserBatch';
    ...
    {
        return [
            'items' => '\Acronis\Cloud\Client\Model\Users\User[]'
        ];
    }
    ...
    /**
     * Gets items
     * @return \Acronis\Cloud\Client\Model\Users\User[]
     */
    ...
    /**
     * Sets items
     * @param \Acronis\Cloud\Client\Model\Users\User[] $items
     * @return $this
     */
