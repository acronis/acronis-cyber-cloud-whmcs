 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SettingOwn extends BaseModel 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Settings\SettingOwn';
    ...
    public function validateLock()
    {
        if (!$this->offsetExists('lock')) {
            return "Property 'lock' was not initialized.";
        }
        return false;
    }
    ...
    public function validateExclusive()
    {
        if (!$this->offsetExists('exclusive')) {
            return "Property 'exclusive' was not initialized.";
        }
        return false;
    }
