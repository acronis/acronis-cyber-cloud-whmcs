 ...
 *
 * @category    Class
 * @description /search/GET response
 * @package     Acronis\Cloud\Client
...
class Search extends BaseModel 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Search\Search';
    ...
    {
        return [
            'items' => '\Acronis\Cloud\Client\Model\Search\SearchItems[]'
        ];
    }
    ...
    /**
     * Gets items
     * @return \Acronis\Cloud\Client\Model\Search\SearchItems[]
     */
    ...
    /**
     * Sets items
     * @param \Acronis\Cloud\Client\Model\Search\SearchItems[] $items
     * @return $this
     */
