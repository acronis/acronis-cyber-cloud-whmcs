 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class IdpBatch extends BaseModel 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IdentityProviders\IdpBatch';
    ...
    {
        return [
            'items' => '\Acronis\Cloud\Client\Model\IdentityProviders\Idp[]'
        ];
    }
    ...
    /**
     * Gets items
     * @return \Acronis\Cloud\Client\Model\IdentityProviders\Idp[]
     */
    ...
    /**
     * Sets items
     * @param \Acronis\Cloud\Client\Model\IdentityProviders\Idp[] $items
     * @return $this
     */
