...
/**
 * OiPricingSettingsItems Class Doc Comment
 *
 * @category    Class
 * @package     Acronis\Cloud\Client
 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class OiPricingSettingsItems extends BaseModel 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Pricing\OiPricingSettingsItems';
    ...
    public function setApplicationId($application_id)
    {
        if ((strlen($application_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $application_id when calling OiPricingSettingsItems., must be smaller than or equal to 36.');
        }
        if ((strlen($application_id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $application_id when calling OiPricingSettingsItems., must be bigger than or equal to 36.');
        }
        if ((!preg_match("/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/", $application_id))) {
            throw new \InvalidArgumentException("invalid value for $application_id when calling OiPricingSettingsItems., must conform to the pattern /[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/.");
        }
    ...
    public function setInfraId($infra_id)
    {
        if (!is_null($infra_id) && (strlen($infra_id) > 36)) {
            throw new \InvalidArgumentException('invalid length for $infra_id when calling OiPricingSettingsItems., must be smaller than or equal to 36.');
        }
        if (!is_null($infra_id) && (strlen($infra_id) < 36)) {
            throw new \InvalidArgumentException('invalid length for $infra_id when calling OiPricingSettingsItems., must be bigger than or equal to 36.');
        }
        if (!is_null($infra_id) && (!preg_match("/[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/", $infra_id))) {
            throw new \InvalidArgumentException("invalid value for $infra_id when calling OiPricingSettingsItems., must conform to the pattern /[0-9a-f]{8}-([0-9a-f]{4}-){3}[0-9a-f]{12}/.");
        }
