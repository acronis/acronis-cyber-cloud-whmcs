 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class TenantBatch extends BaseModel 
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Tenants\TenantBatch';
    ...
    {
        return [
            'items' => '\Acronis\Cloud\Client\Model\Tenants\Tenant[]'
        ];
    }
    ...
    /**
     * Gets items
     * @return \Acronis\Cloud\Client\Model\Tenants\Tenant[]
     */
    ...
    /**
     * Sets items
     * @param \Acronis\Cloud\Client\Model\Tenants\Tenant[] $items
     * @return $this
     */
